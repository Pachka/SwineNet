...
stepwise.selection.forERGM <- function(base.formula = NULL,  #string  stepwise.summary[[stepwise.summary%>% length]]$formula %>% substr(., gregexpr("\\~", base.formula)[[1]][1] - 2, nchar(.)-1)
