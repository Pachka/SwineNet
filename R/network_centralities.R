...
#' @examples
<<<<<<<< HEAD:R/centralities_network.R
#' centralities_network()
========
#' network_centralities()
>>>>>>>> 42f1e3243b0b136dd72c76edb43e40e46dfee4bb:R/network_centralities.R
#'
...
<<<<<<<< HEAD:R/centralities_network.R
centralities_network <- function(network = g, include.distance = FALSE, distance.matrix = NA, distance.att = NA) {
========
